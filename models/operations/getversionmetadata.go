...
type GetVersionMetadataResponse struct {
	...
	// OK
	Classes []components.VersionMetadata
}
...
func (o *GetVersionMetadataResponse) GetError() *components.Error {
	if o == nil {
		return nil
	}
	return o.Error
...
func (o *GetVersionMetadataResponse) GetClasses() []components.VersionMetadata {
	if o == nil {
		return nil
	}
	return o.Classes
