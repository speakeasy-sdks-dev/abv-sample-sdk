...
type GetAllForVersionAPIEndpointsResponse struct {
	...
	// OK
	Classes []components.APIEndpoint
}
...
func (o *GetAllForVersionAPIEndpointsResponse) GetError() *components.Error {
	if o == nil {
		return nil
	}
	return o.Error
...
func (o *GetAllForVersionAPIEndpointsResponse) GetClasses() []components.APIEndpoint {
	if o == nil {
		return nil
	}
	return o.Classes
